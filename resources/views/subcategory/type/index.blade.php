        ...
        <div class="card ">
            <div class="card-body ">
                <div class="row">
                    <div class="col-md-9">
                        <p class="card-text">
                            <h5><b>Category: </b> {{ $subcategory->category->name }} </h5>
                        <h5><b>Subcategory: </b> {{ $subcategory->name }} </h5>
                        <h5 style="margin: 3px"><b>Description: </b> {{ $subcategory->description }} </h5>
                        </p>
                    </div>
                    ...
                    <tbody>
                        @foreach ($subcategorytypes as $subcategory)
                            ...
                            <tr>
                                ...
                                <td>{{ $subcategory->subcategory->category->name }}</td>
                                ...
                                <td>
                                    ...
                                    <a type="button" class="delete" title="Delete"
                                        data-whatever="/subcategorytype/delete/{{ $subcategory->id }}" data-toggle="modal"
